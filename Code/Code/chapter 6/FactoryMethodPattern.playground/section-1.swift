...
var str = "abc123"
var validator1 = getValidator(true, numericCharacters: false)
print("String validated: \(validator1?.validateString(str))")

var validator2 = getValidator(true, numericCharacters: true)
print("String validated: \(validator2?.validateString(str))")
